...
<html>
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="/static/assets/favicon-32x32.png" sizes="32x32" />
        <link rel="icon" type="image/x-icon" href="/static/assets/favicon-16x16.png" sizes="16x16" />
        <title>Live Pad | Pigeonpad</title>
    </head>
    <body>
        ...
        this.bind(router, ([name, params]) => {
            switch (name) {
                ...
                case 'welcome':
                    ...
                    router.go('/h/d6d40c3cd33b/j/ca00fccfb408/edit', { replace: true });
                    break;
                default:
                    {
